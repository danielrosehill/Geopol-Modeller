Run a geopol simulation sequentially across ALL available model pools, generating a PDF report for each.
...
4. For each pool, run: `geopol --pool <name> --report --no-rich -v 0`
