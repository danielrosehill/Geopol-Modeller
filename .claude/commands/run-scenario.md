Run a snowglobe simulation using a scenario file. $ARGUMENTS should be in the format: `<scenario-name> [pool-name]`.
...
4. Verify the scenario exists: `snowglobe --list-scenarios`
5. Run: `snowglobe --scenario <name> --pool <pool> --report`
