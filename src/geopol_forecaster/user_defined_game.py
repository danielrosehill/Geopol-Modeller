...
from geopol_forecaster.core import Configuration, Control, Database, History, LLMClient, Player
...
class UserDefinedGame(Control):
    def __init__(self, config, logger, simulation_mode=False, simulation_name='simulation', run_num=0):
        ...
        # Create LLM client using pool config
        pool = config.pool
        llm_client = LLMClient(base_url=config.base_url)
...
def main():
    ...
    parser.add_argument(
        ...
        default='/home/geopol/logs/geopol.log')
